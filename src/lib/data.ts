...
<br>
      ...
      <ul>
        <li>Primera Capa (Libertad): Son los derechos civiles y políticos, como el derecho a la vida, a la privacidad y a poder elegir a nuestros gobernantes.</li>
        <li>Segunda Capa (Igualdad): Busca que el Estado no solo nos deje ser libres, sino que también nos provea salud, educación y trabajo para que todos vivamos mejor.</li>
        <li>Tercera Capa (Derechos Colectivos): Es la más nueva; protege a grupos vulnerables como niños, personas con discapacidad o grupos indígenas, e incluso nuestro derecho a vivir en un ambiente limpio.</li>
      </ul>

      <br>

      <p>Cuando veo las estadísticas de UNICEF sobre la desnutrición infantil en comunidades indígenas de México, o que todavía hay millones de adultos que no saben leer ni escribir, me doy cuenta de que los Derechos Humanos se quedan en el papel si nosotros no les damos vida.</p>
<br>
